...
JS Recon writes the [common output files](./common-reference.md#output-files) and uploads them to DigitalOcean Spaces via the AWS CLI using the Spaces S3-compatible endpoint.
